...
export function HomeToolMatrix() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6 sm:py-10">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div className="min-w-0">
            ...
            <p className="mt-1.5 max-w-xl text-sm leading-relaxed text-[var(--muted)]">
              Browser calculators for chemistry, mathematics, and computing —
              built for coursework and self-study.
            </p>
          </div>
      ...
      <div id="tools" className="mt-6 min-w-0 space-y-8">
          ...
          ? visibleCategories.map((category) => {
              ...
              return (
                <section key={category}>
                  {section === "all" ? (
                    <div className="mb-2 flex items-baseline justify-between gap-3 border-b border-[var(--border)] pb-2">
