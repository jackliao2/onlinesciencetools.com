...
import { StoichiometryCalculator } from "@/components/tools/stoichiometry/StoichiometryCalculator";
import { buildToolMetadata, buildWebApplicationJsonLd } from "@/lib/seo";
import { categoryLabels, getToolBySlug } from "@/lib/tools";

const tool = getToolBySlug("stoichiometrycalculator")!;
...
export default function StoichiometryCalculatorPage() {
  return (
    <>
      ...
      <PracticeProblems
        slug={tool.slug}
        topicLabel="stoichiometry calculator"
      />
