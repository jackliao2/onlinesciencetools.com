...
import { DilutionCalculator } from "@/components/tools/dilution/DilutionCalculator";
import { buildToolMetadata, buildWebApplicationJsonLd } from "@/lib/seo";
import { categoryLabels, getToolBySlug } from "@/lib/tools";

const tool = getToolBySlug("dilutioncalculator")!;
...
export default function DilutionCalculatorPage() {
  return (
    <>
      ...
      <PracticeProblems slug={tool.slug} topicLabel="dilution calculator" />
