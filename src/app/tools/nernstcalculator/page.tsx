...
import { NernstCalculator } from "@/components/tools/nernst/NernstCalculator";
import { buildToolMetadata, buildWebApplicationJsonLd } from "@/lib/seo";
import { categoryLabels, getToolBySlug } from "@/lib/tools";

const tool = getToolBySlug("nernstcalculator")!;

export const metadata: Metadata = buildToolMetadata(tool);

export default function NernstCalculatorPage() {
  return (
    <>
      ...
      <PracticeProblems slug={tool.slug} topicLabel="Nernst equation" />
