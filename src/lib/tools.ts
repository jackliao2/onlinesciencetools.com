...
export const tools: Tool[] = [
  // Chemistry — reactions
  {
    ...
    description:
      "Balance chemical equations and get the smallest whole-number coefficients, steps, and an atom-check table.",
    category: "chemistry",
    group: "reactions",
    status: "live",
    keywords: [
  ...
  },
  {
    ...
    description:
      "Find the limiting reagent, theoretical yield, and percent yield from a balanced equation and starting amounts.",
    category: "chemistry",
    group: "reactions",
    status: "live",
    keywords: [
  ...
  // Chemistry — solutions
  {
    ...
    shortTitle: "Dilution",
    description:
      "Solve C₁V₁ = C₂V₂ for stock or diluted concentration and volume, or plan a serial dilution (1:10, alcohol, bleach).",
    category: "chemistry",
    group: "solutions",
    status: "live",
    keywords: [
  ...
  },
  {
    ...
    description:
      "Convert molarity (M, mM, μM), g/L, mass percent, ppm, and molality using molar mass and density.",
    category: "chemistry",
    group: "solutions",
    status: "live",
    keywords: [
  ...
  // Chemistry — acids / equilibrium
  {
    ...
    keywords: [
      ...
      "equilibrium expression calculator",
      "Kc calculator",
      "Kp calculator",
      "reaction quotient Q",
  ...
  },
  {
    ...
    description:
      "Phosphate buffer calculator (plus acetate, Tris, citrate, and more)—grams from target pH, total concentration, and volume via Henderson–Hasselbalch.",
    category: "chemistry",
    group: "acids",
    status: "live",
    keywords: [
  ...
  },
  {
    ...
    shortTitle: "Kinetics",
    description:
      "Kinetics calculator for half-life and integrated rate laws—solve for concentration, time, or k in zero-, first-, and second-order reactions.",
    category: "chemistry",
    group: "energy",
    status: "live",
    keywords: [
