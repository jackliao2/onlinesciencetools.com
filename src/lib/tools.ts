...
export const tools: Tool[] = [
  ...
  // Chemistry — solutions
  {
    ...
    shortTitle: "Dilution",
    description:
      "Solve C₁V₁ = C₂V₂ for stock or diluted concentration and volume, or plan a serial dilution (HCl, H₂SO₄, 1:20, 10×, alcohol, bleach).",
    category: "chemistry",
    group: "solutions",
    status: "live",
    keywords: [
  ...
  },
  {
    ...
    shortTitle: "Kinetics",
    description:
      "Kinetics and rate constant calculator for half-life and integrated rate laws—solve for concentration, time, or k in zero-, first-, and second-order reactions.",
    category: "chemistry",
    group: "energy",
    status: "live",
    keywords: [
