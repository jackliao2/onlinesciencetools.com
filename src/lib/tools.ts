...
export const tools: Tool[] = [
  ...
  // Chemistry — acids / equilibrium
  {
    ...
    description:
      "Free chemical equilibrium calculator: solve Kc/Kp problems, reaction quotient Q, ICE tables, and equilibrium amounts.",
    category: "chemistry",
    group: "acids",
    status: "live",
    keywords: [
  ...
  },
  {
    ...
    description:
      "Calculate pH and pOH for strong/weak acids and bases (including ammonia Kb) and simple buffers with the Henderson–Hasselbalch equation.",
    category: "chemistry",
    group: "acids",
    status: "live",
    keywords: [
