...
export const PHASE_PRESETS: PhasePreset[] = [
  {
    id: "center",
    name: "Center (closed orbits)",
    description:
      "Linear center: purely imaginary eigenvalues, closed orbits around the origin. Textbook first portrait.",
    fx: "-y",
    fy: "x",
    xMin: -3,
    xMax: 3,
  ...
  {
    id: "spiral",
    name: "Stable spiral (sink)",
    description: "Damped spiral: complex eigenvalues with negative real part, trajectories spiral in.",
    fx: "-0.3*x - y",
    fy: "x - 0.3*y",
    xMin: -3,
    xMax: 3,
  ...
  {
    id: "spiral-source",
    name: "Unstable spiral (source)",
    description: "Spiral source: complex eigenvalues with positive real part, trajectories spiral out.",
    fx: "0.3*x - y",
    fy: "x + 0.3*y",
    xMin: -3,
    xMax: 3,
  ...
  },
  {
    id: "saddle",
    name: "Saddle point",
    description: "Linear saddle: one stable and one unstable eigendirection.",
    fx: "x",
    fy: "-y",
    xMin: -3,
    xMax: 3,
  ...
  },
  {
    ...
    description: "Both eigenvalues real and negative — trajectories approach the origin.",
    fx: "-x",
    fy: "-2*y",
    xMin: -3,
    xMax: 3,
  ...
  },
  {
    ...
    description: "Both eigenvalues real and positive — trajectories leave the origin.",
    fx: "x",
    fy: "2*y",
    xMin: -3,
    xMax: 3,
  ...
  },
  {
    ...
    description: "Nonlinear oscillator with a stable limit cycle.",
    fx: "y",
    fy: "1.5*(1 - x*x)*y - x",
    xMin: -4,
    xMax: 4,
  ...
  },
  {
    id: "predator",
    name: "Predator–prey",
    description: "Lotka–Volterra cycles between two populations.",
    fx: "x*(1 - y)",
    fy: "y*(x - 1)",
    xMin: -0.5,
    xMax: 3,
  ...
  },
  {
    ...
    description:
      "ẋ = y, ẏ = −sin(x) − 0.5y. Stable spiral at (0,0), saddles at (±π, 0).",
    fx: "y",
    fy: "-sin(x) - 0.5*y",
    xMin: -8,
    xMax: 8,
